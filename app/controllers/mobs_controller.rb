class MobsController < ApplicationController
  ...
  private
    ...
    def mob_params
      params.require(:mob).permit(:name, :race, :type, :resist, :immune, :attack, :dmg, :str, :dex, :con, :int, :wis, :cha, :strsv, :dexsv, :consv, :intsv, :wissv, :chasv, :init, :ac, :passins, :passperc, :passinv, :profbonus, :spells, :hp, :cr)
    end
end
